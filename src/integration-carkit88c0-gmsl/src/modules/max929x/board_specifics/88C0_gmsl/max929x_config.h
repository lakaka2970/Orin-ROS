...
static struct max929x_reg max9296_SPLITTER_MODE_Dser_Ser_init[] = {
    ...
    */
    ...
    {MAX929X_DELAY, 0x0000, 0x78},  // 120 msec delay
    // Video Transmit Configuration for Serializer(s)
    {0x80, 0x0002, 0x03},  // DEV : REG2 | VID_TX_EN_Z (VID_TX_EN_Z): Disabled
    {0x84, 0x0002, 0x03},  // DEV : REG2 | VID_TX_EN_Z (VID_TX_EN_Z): Disabled
    ...
    //
    // MIPI D-PHY Configuration
    {0x80, 0x0330, 0x00},  // MIPI_RX : MIPI_RX0 | (Default) RSVD (Port Configuration): 1x4
    {0x80, 0x0383, 0x00},  // MIPI_RX_EXT : EXT11 | Tun_Mode (Tunnel Mode): Disabled
    {0x80, 0x0331, 0x30},  // MIPI_RX : MIPI_RX1 | (Default) ctrl1_num_lanes (Port B - Lane Count): 4
    {0x80, 0x0332, 0xE0},  // MIPI_RX : MIPI_RX2 | (Default) phy1_lane_map (Lane Map - PHY1 D0): Lane 2 | (Default) phy1_lane_map (Lane Map - PHY1 D1): Lane 3
    {0x80, 0x0333, 0x04},  // MIPI_RX : MIPI_RX3 | (Default) phy2_lane_map (Lane Map - PHY2 D0): Lane 0 | (Default) phy2_lane_map (Lane Map - PHY2 D1): Lane 1
    {0x80, 0x0334, 0x00},  // MIPI_RX : MIPI_RX4 | (Default) phy1_pol_map (Polarity - PHY1 Lane 0): Normal | (Default) phy1_pol_map (Polarity - PHY1 Lane 1): Normal
    {0x80, 0x0335, 0x00},  // MIPI_RX : MIPI_RX5 | (Default) phy2_pol_map (Polarity - PHY2 Lane 0): Normal | (Default) phy2_pol_map (Polarity - PHY2 Lane 1): Normal | (Default) phy2_pol_map (Polarity - PHY2 Clock Lane): Normal
    // Controller to Pipe Mapping Configuration
    {0x80, 0x0308, 0x64},  // FRONTTOP : FRONTTOP_0 | (Default) RSVD (CLK_SELZ): Port B | (Default) START_PORTB (START_PORTB): Enabled
    {0x80, 0x0311, 0x40},  // FRONTTOP : FRONTTOP_9 | (Default) START_PORTBZ (START_PORTBZ): Start Video
    {0x80, 0x0318, 0x6C},  // FRONTTOP : FRONTTOP_16 | mem_dt1_selz (mem_dt1_selz): 0x6C
    // Double Mode Configuration
    {0x80, 0x0313, 0x40},  // FRONTTOP : FRONTTOP_11 | bpp12dblz (bpp12dblz): Send 12-bit pixels as 24-bit
    {0x80, 0x031E, 0x38},  // FRONTTOP : FRONTTOP_22 | (Default) soft_bppz (soft_bppz): 0x18 | soft_bppz_en (soft_bppz_en): Software override enabled
    // Pipe Configuration
    {0x80, 0x005B, 0x00},  // CFGV__VIDEO_Z : TX3 | TX_STR_SEL (TX_STR_SEL Pipe Z): 0x0
    //
    ...
    {0x84, 0x031E, 0x38},  // FRONTTOP : FRONTTOP_22 | (Default) soft_bppz (soft_bppz): 0x18 | soft_bppz_en (soft_bppz_en): Software override enabled
    // Pipe Configuration
    {0x84, 0x005B, 0x01},  // CFGV__VIDEO_Z : TX3 | TX_STR_SEL (TX_STR_SEL Pipe Z): 0x1
    //
    ...
    {0x90, 0x0313, 0x02},  // (CSI_OUT_EN): CSI output enabled
    // Video Transmit Configuration for Serializer(s)
    {0x80, 0x0002, 0x43},  // DEV : REG2 | VID_TX_EN_Z (VID_TX_EN_Z): Enabled
    {0x84, 0x0002, 0x43},  // DEV : REG2 | VID_TX_EN_Z (VID_TX_EN_Z): Enabled

    {0x90, 0x0005, 0x00},  // Deserializer REG5
    {0x80, 0x0005, 0x00},  // Serializer A REG5
    {0x84, 0x0005, 0x00},  // Serializer B REG5
    ...
    {0x80, 0x0170, 0x03},  // Serializer A, enable SPI channel, SPI main, accept packets with ID = 0b00
    {0x84, 0x0170, 0x53},  // Serializer B, enable SPI channel, SPI main, accept packets with ID = 0b01
